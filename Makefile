#############################################################################
# Makefile for building: reflektor
# Generated by qmake (3.0) (Qt 5.2.1)
# Project:  plot-examples.pro
# Template: app
# Command: /usr/lib/qt/bin/qmake -o Makefile plot-examples.pro
#############################################################################
...
CXXFLAGS      = -pipe -march=x86-64 -mtune=generic -O2 -pipe -fstack-protector --param=ssp-buffer-size=4 -std=c++0x -Wall -W -D_REENTRANT -fPIE $(DEFINES)
INCPATH       = -I/usr/lib/qt/mkspecs/linux-g++ -I. -I/usr/include/qt -I/usr/include/qt/QtPrintSupport -I/usr/include/qt/QtWidgets -I/usr/include/qt/QtGui -I/usr/include/qt/QtCore -I. -I.
LINK          = g++
LFLAGS        = -Wl,-O1,--sort-common,--as-needed,-z,relro -Wl,-O1
LIBS          = $(SUBLIBS) -L/usr/local/lib -lportaudio -lm -lfftw3f -lQt5PrintSupport -lQt5Widgets -lQt5Gui -lQt5Core -lGL -lpthread 
AR            = ar cqs
RANLIB        = 
...
Makefile: plot-examples.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/shell-unix.conf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
		...
		/lib/libQt5Gui.prl \
		/lib/libQt5Core.prl
	$(QMAKE) -o Makefile plot-examples.pro
...
dist: 
	@test -d .tmp/reflektor1.0.0 || mkdir -p .tmp/reflektor1.0.0
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/reflektor1.0.0/ && $(COPY_FILE) --parents mainwindow.h qcustomplot.h .tmp/reflektor1.0.0/ && $(COPY_FILE) --parents main.cpp mainwindow.cpp qcustomplot.cpp .tmp/reflektor1.0.0/ && $(COPY_FILE) --parents mainwindow.ui .tmp/reflektor1.0.0/ && (cd `dirname .tmp/reflektor1.0.0` && $(TAR) reflektor1.0.0.tar reflektor1.0.0 && $(COMPRESS) reflektor1.0.0.tar) && $(MOVE) `dirname .tmp/reflektor1.0.0`/reflektor1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/reflektor1.0.0
...
moc_qcustomplot.cpp: /usr/include/qt/QtCore/QObject \
		/usr/include/qt/QtCore/qobject.h \
		/usr/include/qt/QtCore/qobjectdefs.h \
		/usr/include/qt/QtCore/qnamespace.h \
		/usr/include/qt/QtCore/qglobal.h \
		...
		/usr/include/qt/QtPrintSupport/QPrintEngine \
		...
		qcustomplot.h
	/usr/lib/qt/bin/moc $(DEFINES) $(INCPATH) -I/usr/lib/gcc/include/c++/4.8.2 -I/usr/lib/gcc/include/c++/4.8.2/x86_64-unknown-linux-gnu -I/usr/lib/gcc/include/c++/4.8.2/backward -I/usr/lib/gcc/x86_64-unknown-linux-gnu/4.8.2/include -I/usr/local/include -I/usr/lib/gcc/x86_64-unknown-linux-gnu/4.8.2/include-fixed -I/usr/include qcustomplot.h -o moc_qcustomplot.cpp
