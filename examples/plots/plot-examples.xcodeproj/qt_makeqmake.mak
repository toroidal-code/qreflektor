#############################################################################
# Makefile for building: plot-examples.app/Contents/MacOS/plot-examples
# Generated by qmake (2.01a) (Qt 4.8.5) on: Wed Apr 30 00:14:56 2014
# Project:  plot-examples.pro
# Template: app
# Command: /usr/bin/qmake -o plot-examples.xcodeproj/project.pbxproj plot-examples.pro
#############################################################################

QMAKE    = /usr/bin/qmake
plot-examples.xcodeproj/project.pbxproj: plot-examples.pro  /usr/local/Qt4.8/mkspecs/macx-xcode/qmake.conf /usr/local/Qt4.8/mkspecs/common/unix.conf \
	...
	$(QMAKE) -o plot-examples.xcodeproj/project.pbxproj plot-examples.pro
